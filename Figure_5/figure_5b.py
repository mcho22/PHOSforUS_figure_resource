...
plot.plot(fpr_3, tpr_3, linestyle = '--', color = '#4040C0', label = "Horizontal features only // AUC = %0.3f" % metrics.auc(fpr_3, tpr_3))
plot.plot(fpr_2, tpr_2, linestyle = '--', color = '#C04040', label = "Vertical features only // AUC = %0.3f" % metrics.auc(fpr_2, tpr_2))
#plot.plot(fpr_1, tpr_1, linestyle = '--', color = '#808080', label = "PSWM // AUC = %0.3f" % metrics.auc(fpr_1, tpr_1))
...
plot.savefig("reproduced_figure_5b.png")
