...
plot.fill_between(numpy.arange(windowbasis, len(sequence_ascore)+windowbasis, 1), adiff, sequence_ascore, color = "#FF0000", alpha = 0.9, interpolate = True)
plot.fill_between(numpy.arange(windowbasis, len(sequence_ascore)+windowbasis, 1), adiff, value_processed[0], color = "#00F0FF", alpha = 0.9, interpolate = True)
# "#FF0000", "#00F0FF" for figure 2a
# "#B00000", "#0000B0" for figure s10a
...
#plot.show()
plot.savefig("results/reproduced_figure_2a.png")
plot.clf()
